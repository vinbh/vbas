...
[![Platform](https://img.shields.io/badge/platform-linux%20%7C%20macOS-lightgrey?style=flat-square)](https://github.com/vinbh/peek/releases)
...
[![Release](https://img.shields.io/github/v/release/vinbh/peek?style=flat-square&color=3FB950)](https://github.com/vinbh/peek/releases)

<br/>

<img src="demo/git.gif" alt="peek git subcommand completion" width="860"/>
...
<p align="center">
  <img src="demo/cd.gif" alt="peek cd directory drill-down" width="860"/>
</p>
...
<p align="center">
  <img src="demo/files.gif" alt="peek file completion" width="860"/>
</p>
...
Detects your OS and architecture, downloads the right binary from [Releases](https://github.com/vinbh/peek/releases/latest), and installs everything. No Go required.
...
`peek setup` extracts the embedded specs and hooks to `~/.config/peek/` and offers to wire your shell rc files automatically.
...
# After rebuilding: pkill -KILL -f 'peek daemon'
```
...
- [x] **M8** - 121-command catalog (2x), `go install` + embedded specs, `peek setup`, Homebrew tap, deb/rpm/apk packages
- [ ] **M9+** - fish shell, history ranking, LLM fallback, AUR/COPR packages
...
For **commercial use**, [open an issue](https://github.com/vinbh/peek/issues/new) or email `vinayakbhatt@mit.tc`.
